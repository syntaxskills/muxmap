...
- [x] Blank-canvas clicks and panning preserve the selected node's expanded state and keep its terminal open
...
- [x] The bundled stdio MCP adapter can list, read, send, and inspect usage for authenticated Agent channels
