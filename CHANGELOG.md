...
- Made Agent state unmistakable: active work sweeps a green light across its node, Pi uses its own animated matrix, completion jumps the Agent icon, and input requests show a node-corner question mark.
