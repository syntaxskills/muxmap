...
if (mode === 'status') {
  ...
  printJsonStatus(join(homedir(), '.claude/settings.json'), 'claude', ['SessionStart', 'UserPromptSubmit', 'PermissionRequest', 'PreToolUse', 'Notification', 'TaskCreated', 'TaskCompleted', 'SubagentStart', 'SubagentStop', 'Stop', 'StopFailure', 'SessionEnd'])
  printPiStatus()
} else {
  ...
  if (available('claude')) installJson(join(homedir(), '.claude/settings.json'), 'claude', ['SessionStart', 'UserPromptSubmit', 'PermissionRequest', 'PreToolUse', 'Notification', 'TaskCreated', 'TaskCompleted', 'SubagentStart', 'SubagentStop', 'Stop', 'StopFailure', 'SessionEnd'])
